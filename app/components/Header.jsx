      ...
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end me-5 hidden lg:flex">
          <ul className="flex gap-3 px-1">
            <li><Link href='/' className='text-xl btn btn-ghost capitalize font-normal hover:bg-inherit'>Projects</Link></li>
            <li><Link href='/' className='text-xl btn btn-ghost capitalize font-normal hover:bg-inherit'>About</Link></li>
